...
<div class="page-heading">
    <h3>Selamat datang, Aplikasi Surat Desa Girimulya</h3>
</div>
<div class="page-content">
    <section class="row">
                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <h6 class="font-extrabold mb-0">{{ $warga }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    <h6 class="text-muted font-semibold">Total SKKM</h6>
                                    <h6 class="font-extrabold mb-0">{{ $skkm }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    <h6 class="text-muted font-semibold">Total SKU</h6>
                                    <h6 class="font-extrabold mb-0">{{ $sku }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-4">
                    <div class="card">
                        <div class="card-header">
                            <h4>Perbandingan Total Surat Perbulan</h4>
                        </div>
                        <div class="card-body">
                            @yield('bar')
                        </div>
        ...
        {{-- <div class="col-12 col-lg-3"> --}}
            {{-- <div class="card">
                <div class="card-header">
                    <h4>Perbandingan Jenis Surat</h4>
                </div>
                <div class="card-body">
                    <div class="col-12">
                        {!! $chart->container() !!}
