  ...
  <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <div class="card">
        ...
        @foreach ($data as $visimisi)
            <form method="POST" action="{{ URL('/visimisi/update/'. $visimisi->id_visimisi) }}" enctype="multipart/form-data">
            ...
            <a type="button" class="btn btn-secondary" href="{{ url('/visimisi') }}">Cancel</a>
        @endforeach
        </form>
        </div> 
     </div>
