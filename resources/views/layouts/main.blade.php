        ...
        <ul class="menu-inner py-1">
          ...
          {{-- Master Data --}}
            ...
            <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="{{ url('/warga/create') }}" class="menu-link">
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ url('/aparaturdesa') }}" class="menu-link">
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ url('/SKKM') }}" class="menu-link">
                    <div data-i18n="Data Surat Keterangan Miskin">Data Surat Keterangan Miskin</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ url('/SKKM/create') }}" class="menu-link">
                    <div data-i18n="Tambah Surat Keterangan Miskin">Tambah Surat Keterangan Miskin</div>
                    </a>
                </li>
                </ul>
            </li>
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ url('/SKU') }}" class="menu-link">
                    <div data-i18n="Data Surat Keterangan Usaha">Data Surat Keterangan Usaha</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{  url('/SKU/create') }}" class="menu-link">
                    <div data-i18n="Tambah Surat Keterangan Usaha">Tambah Surat Keterangan Usaha</div>
                    </a>
                </li>
                </ul>
            </li>
            ...
            <li class="menu-item">
                <a href="{{ url('/sejarah') }}" class="menu-link">
            ...
            <li class="menu-item">
                <a href="{{ url('/visimisi') }}" class="menu-link">
            ...
            <li class="menu-item">
                <a href="{{ url('/dokumentasi') }}" class="menu-link">
            ...
            <li class="menu-item">
                <a href="{{ url('/komentar') }}" class="menu-link">
